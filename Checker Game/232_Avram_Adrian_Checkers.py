...
class Joc:
    ...
    def __init__(self, tabla=None):
        self.matr = tabla or copy.deepcopy(Test2.matrice())
        #print(Test.matrice())
...
def min_max(stare):
    ...
    if stare.adancime == 0 or stare.tabla_joc.final(stare.j_curent):
        ...
        print(stare.adancime,stare.tabla_joc.final(stare.j_curent))
        return stare
...
def alpha_beta(alpha, beta, stare):
    if stare.adancime == 0 or stare.tabla_joc.final(stare.j_curent):
        global nra,altu
        #print(stare.tabla_joc.final(stare.j_curent))
        stare.scor = stare.tabla_joc.estimeaza_scor(stare.j_curent,stare.adancime)
        
        return stare
    if alpha >= beta:
        return stare  # este intr-un interval invalid deci nu o mai procesez
    stare.tabla_joc.l_mutari=[]
    stare.mutari_posibile = stare.mutari()
